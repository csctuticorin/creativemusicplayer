...
const playlist = [
  ...
  { title: "Rathamaarey", src: "Rathamaarey-MassTamilan.dev.mp3", image: "download.jpeg" },
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const playlist = [
      { name: 'Kadharalz', src: 'Kadharalz.mp3' },
      { name: 'Andha kanna paathakaa', src: 'Andha-Kanna-Paathaakaa-MassTamilan.io.mp3' },
      { name: 'Arabic kuthu', src: 'Arabic-Kuthu---Halamithi-Habibo-MassTamilan.so.mp3' },
      { name: 'Ethir Neechal', src: 'Ethir-Neechal.mp3' },
      { name: 'Pakkam vanthu', src: 'Pakkam-Vanthu.mp3' },
      { name: 'Rathamaarey', src: 'Rathamaarey-MassTamilan.dev.mp3' },
      { name: 'Selfie pulla', src: 'Selfie-Pulla.mp3' },
      { name: 'Vaathi coming', src: 'Vaathi-Coming-MassTamilan.io.mp3' },
      { name: 'Nee partha', src: 'Nee-Partha.mp3' },
      { name: 'Aathi', src: 'Aathi.mp3' }
    ];
